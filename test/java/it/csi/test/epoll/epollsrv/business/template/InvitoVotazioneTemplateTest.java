...
@Transactional
public class InvitoVotazioneTemplateTest {
    ...
    public void testCreaContenutoEmail () {
        ...
        File emailInvitoVotazioneFile = new File("email_invito_votazione.html");
    ...
    private PollDTO creaDTO () {
        ...
        testo.add ( "Buongiorno, &egrave; stata indetta una nuova votazione." );
        testo.add ( "La votazione prevede che venga espresso un voto in merito a XXXXXX." );
